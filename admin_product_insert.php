...
<!-- Form Name -->
<h2><svg xmlns="http://www.w3.org/2000/svg" width="32" height=32" fill="currentColor" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16">
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM8.5 7v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 1 0z"/>
</svg> เพิ่มข้อมูลสินค้า</h2>
<br>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="p_type">ประเภท</label>
  <div class="col-md-4">  
  <select id="p_type" name="p_type">
  <option value="1">โทรศัพท์มือถือ</option>
  <option value="2">แท็บเล็ต</option>
  <option value="3">อุปกรณ์เสริม</option>
  </select>
  </div>
</div>
  ...
  <div class="col-md-4">
	...
	<?php
		if(isset($_POST['Submit'])){
			...
			$sql = "INSERT INTO `product` (`p_id`, `p_name`, `p_detail`, `p_price`, `p_picture`, `p_type`, `p_filename`) 
			VALUES ('{$_POST['p_id']}', '{$_POST['p_name']}', '{$_POST['p_detail']}', '{$_POST['p_price']}', '{$_POST['p_picture']}', '{$_POST['p_type']}', '{$_POST['p_id']}.jpg');";
			mysqli_query($conn,$sql) or die ("บันทึกข้อมูลไม่ได้");	
			
			@copy($_FILES['p_picture']['tmp_name'],"".$_POST['p_id'].".jpg");		
